...
```bash
# no install, via uvx
claude mcp add ga4gh -- uvx --from git+https://github.com/ga4gh/ga4gh-agentic-harness-mcp ga4gh-mcp
...
claude mcp add ga4gh -e GA4GH_MCP_AUTH_CONFIG=/abs/path/auth.json -- \
  uvx --from git+https://github.com/ga4gh/ga4gh-agentic-harness-mcp ga4gh-mcp
```
